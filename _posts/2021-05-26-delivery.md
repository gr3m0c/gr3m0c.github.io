...
{:refdef: style="text-align: center;"}
[![Support-Center](/assets/images/delivery/support_home.png)](/assets/images/delivery/support_home.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
[![Mattermost-register](/assets/images/delivery/mattermost_home.png)](/assets/images/delivery/mattermost_home.png)
{: refdef}

In a first step we create a ticket on the helpdesk platform.

{:refdef: style="text-align: center;"}
[![File-ticket](/assets/images/delivery/create_ticket.png)](/assets/images/delivery/create_ticket.png)
{: refdef}

This gives us a temporary email to add information to the ticket.

{:refdef: style="text-align: center;"}
[![Ticket-created](/assets/images/delivery/ticket.png)](/assets/images/delivery/ticket.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
[![Mattermost-email](/assets/images/delivery/registration.png)](/assets/images/delivery/registration.png)
{: refdef}

{:refdef: style="text-align: center;"}
[![Mattermost-login](/assets/images/delivery/logged_in.png)](/assets/images/delivery/logged_in.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
[![Discussion](/assets/images/delivery/conversation.png)](/assets/images/delivery/conversation.png)
{: refdef}
