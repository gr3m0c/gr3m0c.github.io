---
title:     "Hack The Box - Previce"
tags: [easy,linux,command injection,sudo,cracking,hashcat]
categories: HackTheBox
---
[![info_card](/img/previce/info_card.png)](/img/previce/info_card.png)
...
[![home](/img/previce/home.png)](/img/previce/home.png)
...
[![account_variables](/img/previce/account_variables.png)](/img/previce/account_variables.png)

Sending a post request with all 3 variables we see that our account was successfully created.

[![account_create](/img/previce/account_create.png)](/img/previce/account_create.png)

This enables to log into the webpage now.

[![logged_in](/img/previce/logged_in.png)](/img/previce/logged_in.png)

## Source code => command injection

Going over to the `files` tab we see a `sitebackup.zip` which we can download.

[![backup](/img/previce/backup.png)](/img/previce/backup.png)
...
[![burp_rce](/img/previce/burp_rce.png)](/img/previce/burp_rce.png)
